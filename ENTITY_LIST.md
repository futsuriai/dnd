...
- `ordonne`: Ordonne
- `pharus`: Pharus
- `shadier-bar-east`: Shadier Bar (East Bastion)
- `small-watch-house`: Small Watch-House (Prison #1)
- `sommeil`: Sommeil
- `stone-span-bridge`: Stone-span Bridge
- `stonewall-tower`: Stonewall Tower
