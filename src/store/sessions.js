...
export const sessions = [
  {
    ...
    time: '1:00 PM',
    upcoming: true,
    description: 'The party embarks on an infiltration of the Duskbreaker Lighthouse to uncover the truth about Meri\'s disappearance and the conspiracy behind the warforged constructs. With extensive underground facilities to explore and dark secrets to unravel, the investigation will test both their stealth and their resolve.',
    highlights: [],
  },
  {
    id: 'session-4',
