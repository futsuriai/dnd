...
export const sessions = [
  {
    ...
    time: '1:00 PM',
    upcoming: true,
    description: 'With Director Faberge\'s pass in hand and the lighthouse\'s secrets partially exposed, the party must decide their next move. Will they risk immediate descent into the basement levels before the Director\'s absence is discovered, or consolidate their position through alliances and intelligence gathering? The truth about Meri and the lighthouse\'s ultimate purpose awaits in the depths below.',
    highlights: [],
  },
  {
    id: 'session-5',
